...
.notif-header span { font-weight: 600; font-size: 14px; }
.notif-header a { font-size: 12px; color: #2563EB; text-decoration: none; }
.notif-item {
  padding: 12px 16px;
...
.notif-icon.order   { background: rgba(37,99,235,0.1);  color: #2563EB; }
.notif-icon.payment { background: rgba(16,185,129,0.1); color: #059669; }
.notif-icon.register{ background: rgba(124,58,237,0.1); color: #7C3AED; }
    ...
    <?php endif; ?>
          ...
          <div class="notif-dropdown" id="notifDropdown">
            <div class="notif-header">
              <span>Notifikasi <?php if ($unreadCount > 0): ?><span style="color:#dc2626">(<?= $unreadCount ?>)</span><?php endif; ?></span>
