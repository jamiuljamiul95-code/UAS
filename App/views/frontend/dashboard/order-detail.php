...
<div class="row g-3">
  <div class="col-md-8">
    ...
    <div class="admin-card">
      ...
      <?php if (!empty($order['payment_proof'])): ?>
        ...
        <?php endif; ?>
      <?php else: ?>
        <p class="small text-secondary mb-0">Belum ada bukti pembayaran yang diupload untuk order ini.</p>
      <?php endif; ?>
    </div>
  </div>
  ...
  <div class="col-md-4">
    ...
    <div class="admin-card">
      ...
      <p class="small text-secondary mb-3">Cek dulu bukti pembayaran di samping sebelum ubah status jadi
        "Dibayar".</p>
