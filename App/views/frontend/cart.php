            ...
            <div class="p-4 rounded-4 border" style="background:#F9FAFB">
                ...
                <form action=" <?=BASE_URL?>/cart/coupon" method="POST" class="mb-3">
                    <div class="input-group">
                        <input type="text" name="code" class="form-control" placeholder="Kode voucher"
                    ...
                    <small
                        class="text-danger"><?= $_SESSION['coupon_error']; unset($_SESSION['coupon_error']); ?></small>
                    <?php endif; ?>
                </form>
                ...
                <a href=" <?=BASE_URL?>/checkout" class="btn btn-primary w-100 rounded-pill py-2 fw-semibold">Lanjut ke
                    Checkout</a>
            </div>
        </div>
    </div>
